...
namespace SH_hmjh_RegularEvaluationScoreReport
{
    public partial class ConfigForm : FISCA.Presentation.Controls.BaseForm
    {
            ...
            catch
            {
                ...
                if (sd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    try
                    {
                        ...
                        stream.Write(Properties.Resources.和美_定期評量成績單樣板, 0, Properties.Resources.和美_定期評量成績單樣板.Length);
                        stream.Flush();
                        stream.Close();
        ...
        private void lbd01_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
                try
                {
                    Aspose.Words.Document doc = new Aspose.Words.Document(new MemoryStream(Properties.Resources.和美_定期評量成績單樣板));
